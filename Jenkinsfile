...
//        e.g https://github.com/matthew-perry/api-server.git might become https://github.com/MyName/external.git
// variables:
...
//      https://github.com/matthew-perry/api-server.git
//      matperry
//      api-server-image
//      cluster-1
...
pipeline {
   ...
   environment {
        ...
        imageName = 'matperry/api-server-image'
        dockerImage = ''
        }
    stages {
        stage('Run the tests') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/matthew-perry/api-server.git'
